function [PN, dynamicpart] = supervisor(PN, dynamicpart, constraints)
%        [PN, dynamicpart] = supervisor(PN, dynamicpart, constraints)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SIMPLE SUPERVISOR: all transitions are observable & controllable
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Dc = -1 * L * Dp;  
muC = B  - L * m0'; 
