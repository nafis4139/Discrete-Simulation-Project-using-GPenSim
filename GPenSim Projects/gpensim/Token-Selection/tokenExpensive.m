function [set_of_tokID, nr_token_av] = tokenExpensive(placeI, nr_tokens_wanted)
%       "token-Most-Expensive"
...
% This function selects the most expensive tokens :
%  e.g. Select three tokens from place 'p1' that are most expensive: 
%          tokenExpensive('p1', 3)   
...
[cts, sinds] = sort(token_costs, 2, 'descend');
